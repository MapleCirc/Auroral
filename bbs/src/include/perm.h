...
#define	PERM_LABEL      0x00000100      /* 09 : 自訂標籤*/
...
/* dust.090320: 拔掉「看到忍者」權限，實質上保留PERM_SEECLOAK */
#if 1
#define PERM_SEECLOAK	0x02000000
#endif

#define PERM_SpSYSOP	0x04000000	/* dust.090320: 新增sysop 超站務 */

/* dust.090320: 廢除各總管，但保留所有常數以防止新舊不相容 */
#if 1
...
#if 0	/* dust.090320說明: 關於新版站務權限 */

    將原本的總管(PERM_REGISTRAR, PERM_ACCOUNTS, PERM_CHATROOM, PERM_BOARD)
  全數註解掉，並將 PERM_ALLADMIN、PERM_ALLREG、PERM_ALLACCT、PERM_ALLCHAT、
  PERM_ALLBOARD 的定義改為 PERM_SYSOP

    新增PERM_SpSYSOP(找一個"保留欄位"來放，不要蓋到註解掉的那些)做為最高位
  權力的判定，並在bbsd.c中動態給予。
...
#else
#define PERM_ALLADMIN   PERM_SYSOP
#define PERM_ALLREG     PERM_SYSOP
#define PERM_ALLACCT    PERM_SYSOP
#define PERM_ALLCHAT    PERM_SYSOP
#define PERM_ALLBOARD   PERM_SYSOP
#define PERM_IPREADER   PERM_SYSOP	/* davy.110926: 強制閱讀IP */
#endif
...
#define STR_PERM	"bctpjm#xe----k-@PTCM--L*B-s----S"	/* itoc: 新增權限的時候別忘了改這裡啊 */
