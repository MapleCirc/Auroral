...
#define	POST_SPMS	0x00000200	/* dust.080211: 特殊標記(搜尋用) */
#define	POST_OUTGO	0x00000400	/* 須轉信出去 */
#define	POST_RESTRICT	0x00000800	/* 加密的文章，須 manager/owner 才能看 */
#define POST_DONE       0x00002000      /* qazq.030815: 站方處理完標記ｓ */
#define POST_RESERVED	0x00001000	/* 被鎖定的文章 */
#define POST_14		0x00002000
#define POST_SCORE	0x00004000	/* 標記評分過的 */
#define POST_16		0x00008000

#define POST_LOCKCLEAR (POST_DELETE | POST_SPMS | POST_DONE)
/* dust.080201: 加上 POST_RESERVE 時所需要消除掉的文章屬性 */
...
#define	MAIL_RESTRICT	0x00000800	/* 加密的信件，須 manager/owner 才能看 */
...
#define	GEM_RESTRICT	0x00000800	/* 加密的精華區，須 manager/owner 才能看 */
