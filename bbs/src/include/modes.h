...
#define PALTYPE_BWLIST	4		/* 水桶名單 */
#define PALTYPE_BVLIST  5		/* floatJ.091017: 板助名單 */
					/* BTW, 那個BWLIST是dust寫的吧...怎麼不著明一下 囧? */
					/* 沒必要 */
...
#define FRCSAV          0x8000		/* dust.100828: 不論長度強制寫進lastcmd[]裡 */
...
#define STAT_CANCEL	0x0200000	/* match看板/名單時沒有輸入任何東西(視為取消) */
...
#define BRD_C_BIT	0x0080		/* .CRH 中有閱讀紀錄 */
...
#define EDIT_MODIFYPOST 0x0040		/* dust.100831: 編輯看板上的文章 */
#define EDIT_BOTTOM     0x0080		/* dust.100831: 置底存檔 */
#ifdef HAVE_TEMPLATE
# define EDIT_TEMPLATE  0x0100		/* dust.100831: 使用文章樣板 */
#endif
#define EDIT_POSTREPLY	0x0200		/* dust.110923: 回覆文章 */
