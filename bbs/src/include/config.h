...
#define SCHOOLNAME	"一串電研"		/* 組織名稱 */
#define BBSNAME		"極光鯨藍"		/* 中文站名 */
#define BBSNAME2	"TCIRC"	  		/* 英文站名 */
#define SYSOPNICK	"客服長"		/* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"	/* 身分認證函 token */

#define MYIPADDR	"210.60.107.213"	/* IP address */
#define MYHOSTNAME	"tcirc.twbbs.org"	/* 網路地址 FQDN */
...
#define BAKPATH		"/backup2"		/* 備份檔的路徑 */

#define BBSUID		1001
#define BBSGID		1001			/* 參考目前的BBS帳號的UID */
...
#define M3_USE_PMORE            /* dust.091029: 使用piaip's more */
#define M3_USE_PFTERM           /* dust.091029: 使用piaip's flat terminal system, the perfect terminal! */
...
#define USE_DUST_KRANS          /* davy.20120623: 使用灰塵大大的 krans */
#define USE_DAVY_REGISTER       /* davy.20120624: 使用新‧註冊單審核系統 */

#ifdef USE_DAVY_REGISTER
# define HAVE_REGISTER_FORM     /* 強制開啟註冊單認證 */
#endif
...
#undef	EMAIL_JUSTIFY		/* 發出 Internet Email 身分認證信函 */
...
#define HAVE_TEMPLATE		/* floatj.080908: 文章範本 */
				/* 要拿掉POST_PREFIX時記得連這個一起拿(雖然不太可能拿掉POST_PREFIX就是...) */
...
#define	MOVE_CAPABLE		/* dust.070817: 移動文章順序 */ 

#define BOTTOM "\033[35m▼\033[m"
/* dust.070820: 置底文的標誌 含顏色 */
...
#  undef HAVE_TIP		/* itoc.010301: 提供每日小秘訣 */
...
#  define SP_SEND_MONEY		/* dust.080104: 站長發錢功能 */
#endif
...
#define MAXAPPLY	100000		/* 最大帳號註冊人數 */
...
#define GUEST_MULTI_MAX	10		/* guest人數上限 */

/* bbsd.c guest帳號的設定 */

#define GUEST_NICK_LIST_MAX 9
#define GUEST_NICK_LIST {"雪花", "蘿蔔", "帽子", "圍巾", "結晶", "鈕扣", "水桶", "雪人", "樹枝"}

#define GUEST_FROM_LIST_MAX 16
#define GUEST_FROM_LIST {"北極點", "入德之門", "電研餐\廳", "餅乾綠園道", "麗澤廣場", "吾覆今日", "慎思攀岩場", "光中農場", "瘋人冰", "樟園森林遊樂區", "有希樓", "藝術中心交誼廳", "阿斯溫泉會館", "躲貓貓社辦", "敬業火爐", "多多按摩坊"}
...
#define	MAX_BBSMAIL	1000		/* PERM_MBOX 收信上限(封) */
...
#define MARK_DUE        1080		/* 標記保存之信件保留時間(天) */
#define MAIL_DUE        720		/* 一般信件保留時間(天) */
#define FILE_DUE        360		/* 其他檔案保留時間(天) */
#endif

/* newbrd.c 看板連署 */

#ifdef HAVE_COSIGN
#define NBRD_NUM_BRD	5		/* 開板需要連署人數 */
#define NBRD_DAY_BRD	10		/* 開板可連署天數 */
#endif
...
#define PREFIX_MAX	10
#define PREFIX_LEN	21
#define DEFAULT_PREFIX	{"[公告]", "[測試]", "[閒聊]", "[灌水]", "[無聊]", "[文件]", "[紀念]", "[創作]", "[打混]", "[好發]"}

/* more.c  Post Law 的行數上限 */
...
#ifdef TIME_KICKER
#define IDLE_TIMEOUT	70		/* visio.c bguard.c 發呆過久自動簽退(分) */
#define IDLE_WARNOUT	3		/* visio.c 發呆過久提醒(分) -- 自動簽退前三分鐘前 */
#endif

/* more.c edit.c 翻頁 */
#define ESCODE_MAXLEN	15		/* dust.100831: esc-star控碼最大長度 */
...
#define	MOVIE_SIZE	(120 * 1024)	/* 動畫 cache size */
#define FILM_SIZ	4096		/* 單張畫面最大大小 */
#define OPENING_MAX	10		/* 開頭畫面的最大數量 */
...
#define BMTA_PORT	3026		/* SMTP   所用的 port (bmtad.c) */
#define GEMD_PORT	70		/* Gopher 所用的 port (gemd.c) */
#define FINGER_PORT	79		/* Finger 所用的 port (bguard.c) */
#define BHTTP_PORT	8001		/* HTTP   所用的 port (bhttpd.c) */
