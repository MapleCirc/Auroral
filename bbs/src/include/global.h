...
#define DEFMETER_BIT    0x80000000	/* dust.100315: 給倒數計時器相關函數用的 */
...
#define FN_PBP      ".PBP"	/* for pmore Browsing Preference */
...
#define FN_BWLIST   "bwlist"	/* 水桶名單 */
#define FN_BVLIST   "bvlist"	/* 板助名單 */

#define FN_MCD      "mcd"       /* dust.100312: 選單倒數計時 */
...
#define FN_RFINFO   "rform.inf"	/* 額外記錄填註冊單的資料，供acct_show使用 */
...
#  define FN_REGISTER "reg"        /* Register */
# endif
#endif
...
#define FN_RUN_SYSOP	"run/sysop.log"	  /* dust.090320: sysop log */
#define FN_RUN_CIRCGOD  "run/circgod.log" /* floatJ.091031: circgod log */
...
#ifdef SP_SEND_MONEY
#define FN_RUN_BONUS_LOG "run/bonus.log"	/* SYSOP發錢紀錄 */
#endif
...
#define FN_RUN_MAILFAIL_LOG "run/mailfail.log"  /* 寄信失敗的記錄 */
...
#define FN_RUN_SPPERM	"run/spcperm"	/* 特殊權限使用者統計 */
#define FN_RUN_MODBM	"run/modibm"	/* 變動的板主名單 */

#define BMTA_LOGFILE    "run/bmta.log"  /* 收外部信的記錄 */

#define FN_TMP_SENDMAIL "tmp/mailinfo.%d.pipe.tmp"
...
#define FN_ETC_BADLABEL "etc/badlabel"   /* 禁止使用的標籤(配合標籤系統) */
...
#define FN_ETC_CIRCGOD "etc/circgodlist"  /* floatJ: 幻符 */

#define FN_ETC_MCD "etc/"FN_MCD
...
#define BN_REGLOG   "register_log"	/* 註冊單審核紀錄放置區 */

#define BN_NULL     "(undefine)"	/* 進站後還沒進入任何看板，所顯示的看板名稱 */
...
#define Ctrl(c)     (c & '\037')
#define Esc(c)      (c | 0x80000000)	/* dust.100919: 重新設置Esc組合鍵 */
#define isprint2(c) (c >= ' ')
...
#define STR_ANONYMOUS   "冰原上的路人"        /* 要短於 IDLEN 個字 */
#define STR_ANONYFROM	"冰與海的邊緣"
...
#define MSG_DEL_ERROR   "刪除時發生錯誤"
#define MSG_DEL_NY  "確定要刪除嗎?(Y/N) [N] "

#define MSG_SURE_NY "請確定。(Y/N) [N] "
#define MSG_SURE_YN "請確定。(Y/N) [Y] "

#define MSG_MULTIREPLY  "確定要群組回信(Y/N)？[N] "

#define MSG_BID     "請輸入看板名稱："
#define MSG_UID     "請輸入代號(ID)："
#define MSG_PASSWD  "請輸入密碼："

#define ERR_BID     "此看板不存在..."
#define ERR_UID     "沒有這個人..."
#define ERR_PASSWD  "密碼錯誤！"
#define ERR_EMAIL   "不合格的 E-mail address"

#define MSG_SENT_OK "信已寄出"

#define MSG_LIST_OVER   "您的名單中的使用者過多，請善加整理"

#define MSG_COINLOCK    "不能開分身進行這樣的服務喔~*"
#define MSG_REG_VALID   "您已經通過身分認證，請重新上站"

#define MSG_LL      "\033[32m[群組名單]\033[m\n"
#define MSG_DATA_CLOAK  "\033[1;30m<資料保密>\033[m\n"
